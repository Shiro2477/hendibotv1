...
➸ *Official Groups*: 
- https://bit.ly/3dp5h1t

➸ *Follow IG*:
- https://instagram.com/hendy29_

➸ *Official Website*:
- https://www.hendizro.com
- https://chordindonesia.my.id
- https://hzrossh.site
=======================
...
4. *${prefix}joox*
Putar lagu atau download lagu dari joox.
Aliases: joox
...
10. *${prefix}linedl*
S1iker Line downloader.
Aliases: -
Usage: *${prefix}linedl* link_stiker

12. *${prefix}movie*
Cari link download film.
Aliases: -
Usage: *${prefix}movie* judu
...
9. *${prefix}stickernobg*
Merubah gambar menjadi sticker tidak ada beckground.
Aliases: *stickernobg*
Usage: Usage: Kirim gambar dengan caption *${prefix}stickernobg* atau reply gambar dengan caption *${prefix}stickernobg*.
...
21. *${prefix}gamelogo*
Membuat logo game sebuah team dengan teks.
Aliases: -
Usage: *${prefix}gamelogo* nama_team
